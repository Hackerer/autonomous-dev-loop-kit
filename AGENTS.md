...
Use `.agents/skills/autonomous-dev-loop` when the user asks for autonomous iteration, repeated version shipping, “自主循环开发”, “自动迭代开发”, or any request to keep delivering successive versions with testing, Git publication, and reports.
